...
src/
  ...
  sync/           Sincronización entre dispositivos (Supabase) — en curso
    ...
    SyncSection.tsx         Inicio/cierre de sesión con link mágico (dentro de Configuración → Sincronización)
